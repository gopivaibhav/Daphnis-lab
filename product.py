...
for URL in urlcheck.get_urls():
# urlList = ['https://eur.shein.com/DAZY-High-Waist-Fold-Pleated-Pants-p-11556449-cat-1740.html']
# for URL in urlList:
    r = session.get(URL)
    ...
    finaldataforjson['URL'] = URL.split('?')[0]
    ...
    #     outfile.write(json.dumps(finaldataforjson, indent = 3))
    #     outfile.write(",")
    #     outfile.close()
